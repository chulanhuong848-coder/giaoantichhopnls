...
<div class="main-header">
    ...
    <p>Tác giả: Chu Thị Lan Hương - Trường Tiểu học Lực Hành - ĐT: 0977 910 656</p>
</div>
""", unsafe_allow_html=True)
...
# --- CHÂN TRANG ---
st.markdown("---")
st.markdown("<div style='text-align: center; color: #666;'>© 2025 - Chu Thị Lan Hương - Trường Tiểu học Lực Hành - ĐT: 0977 910 656</div>", unsafe_allow_html=True)
